...
export function Home() {
  ...
  return (
    <div className="min-h-full bg-[#050505] text-white pb-20 flex flex-col items-center pt-24">
      <motion.div 
      ...
      >
        <h1 className="text-5xl md:text-7xl font-extrabold mb-4 tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-200 to-gray-500">
      ...
      >
        <div className="protected-video relative aspect-video rounded-3xl overflow-hidden glass-card bg-black group">
          ...
          />
          <div className="absolute top-0 left-0 w-full p-8 bg-gradient-to-b from-black/90 via-black/40 to-transparent pointer-events-none transition-opacity duration-500 group-hover:opacity-0 z-30">
            <span className="text-[#E62429] font-bold tracking-widest text-xs uppercase mb-2 block">{getText("Home", "Video Badge")}</span>
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight">{getText("Home", "Video Title")}</h2>
            <p className="text-gray-300 mt-2 max-w-xl font-medium text-sm">{getText("Home", "Video Subtitle")}</p>
          </div>
        </div>
      </motion.div>
